                ...
                <div className="mt-8 flow-root">
                    ...
                    <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <thead>
                            ...
                            <th scope="col" className="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-gray-900 sm:pr-0">#</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-200 bg-white">
                            {groups && groups.map((group: any) => (
                                <tr key={group.id} className="divide-x divide-gray-200">
                                    ...
                                    <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-0 grid grid-cols-2 gap-1">
